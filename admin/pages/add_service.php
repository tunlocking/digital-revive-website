...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $stmt = $conn->prepare("
            INSERT INTO services (name, slug, category, description, detailed_description, price, estimated_days, status, icon)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
        ");
        $stmt->execute([$name, $slug, $category, $description, $detailed_desc, $price, $estimated_days, $status, $icon]);
        $success = true;
...
<head>
    ...
    <title>Add Service - Digital Revive Admin</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 col-lg-10 px-md-4">
                <h2 class="mt-4 mb-4"><i class="fas fa-plus"></i> Add New Service</h2>
                        ...
                        <form method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <small class="text-muted">URL-friendly name (e.g., smartphone-screen-repair)</small>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="icon" name="icon" value="<?php echo htmlspecialchars($_POST['icon'] ?? ''); ?>" placeholder="e.g., fas fa-mobile-alt">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="price" name="price" step="0.01" value="<?php echo htmlspecialchars($_POST['price'] ?? ''); ?>">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="estimated_days" class="form-label">Estimated Days to Complete</label>
                                    <input type="number" class="form-control" id="estimated_days" name="estimated_days" min="1" value="<?php echo htmlspecialchars($_POST['estimated_days'] ?? '1'); ?>">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="detailed_description" name="detailed_description" rows="4"><?php echo htmlspecialchars($_POST['detailed_description'] ?? ''); ?></textarea>
                            </div>
